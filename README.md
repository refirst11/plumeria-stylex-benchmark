...
- **React**: 19.2.4
- **Libraries**: StyleX 0.18.3 / Plumeria 13.1.5
- **Node.js**: v25.8.2
- **pnpm**: v11.3.0
- **OS**: macOS Tahoe
...
| :----------- | :-----------: | :-----: | :-----: | :-----------: | :---------------: |
| **StyleX**   |    4.168s     |  4.08s  |  4.23s  |    8.08KB     |      100/100      |
| **Plumeria** |    3.912s     |  3.86s  |  4.00s  |    7.64KB     |      100/100      |
...
This benchmark confirms that Plumeria can achieve **reduced build time (approximately 6.1% reduction) and reduced bundle size (approximately 5.4% reduction)** while maintaining the same high level of execution performance as StyleX.
