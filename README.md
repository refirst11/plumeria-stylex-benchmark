...
- **React**: 19.2.4
- **Libraries**: StyleX 0.18.3 / Plumeria 16.2.4
- **Node.js**: v25.8.2
- **pnpm**: v11.3.0
- **OS**: macOS Tahoe
...
| :----------- | :-----------: | :-----: | :-----: | :-----------: | :---------------: |
| **StyleX**   |    4.263s     |  4.17s  |  4.33s  |    8.08KB     |      100/100      |
| **Plumeria** |    4.003s     |  3.95s  |  4.08s  |    7.79KB     |      100/100      |
...
This benchmark confirms that Plumeria can achieve **reduced build time (approximately 6.1% reduction) and reduced bundle size (approximately 3.6% reduction)** while maintaining the same high level of execution performance as StyleX.
